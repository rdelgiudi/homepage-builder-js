    ...
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 flex items-center gap-4 shadow-sm dark:shadow-none border border-gray-200 dark:border-0">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500">Check your Server ID</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 flex items-center gap-4 shadow-sm dark:shadow-none border border-gray-200 dark:border-0">
      ...
      <div className="text-left">
        <p className="font-semibold text-gray-900 dark:text-white">{widget.name}</p>
      ...
      {widget.instant_invite && (
        <a
          ...
          className="ml-auto px-4 py-2 bg-[#5865F2] hover:bg-[#4752C4] rounded-lg transition-colors text-sm text-white"
        >
          Join
        </a>
      )}
